...
class NetworkFeatureAdapter(private val features: List<NetworkFeature>) : 
    RecyclerView.Adapter<NetworkFeatureAdapter.FeatureViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeatureViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_network_feature, parent, false)
    ...
    override fun onBindViewHolder(holder: FeatureViewHolder, position: Int) {
        ...
        when (feature.status) {
            "Active" -> {
                ...
                holder.actionButton.text = holder.itemView.context.getString(R.string.use)
