...
class SyncFeatureAdapter(private val features: List<SyncFeature>) : 
    RecyclerView.Adapter<SyncFeatureAdapter.FeatureViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeatureViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_sync_feature, parent, false)
