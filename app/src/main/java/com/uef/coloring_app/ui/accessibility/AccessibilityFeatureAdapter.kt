...
class AccessibilityFeatureAdapter(private val features: List<AccessibilityFeature>) : 
    RecyclerView.Adapter<AccessibilityFeatureAdapter.FeatureViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeatureViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_accessibility_feature, parent, false)
