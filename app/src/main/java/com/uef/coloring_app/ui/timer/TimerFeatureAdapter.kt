...
class TimerFeatureAdapter(private val features: List<TimerFeature>) : 
    RecyclerView.Adapter<TimerFeatureAdapter.FeatureViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeatureViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_timer_feature, parent, false)
