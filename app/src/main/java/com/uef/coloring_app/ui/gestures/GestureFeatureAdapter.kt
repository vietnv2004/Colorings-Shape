...
class GestureFeatureAdapter(private val features: List<GestureFeature>) : 
    RecyclerView.Adapter<GestureFeatureAdapter.FeatureViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeatureViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_gesture_feature, parent, false)
