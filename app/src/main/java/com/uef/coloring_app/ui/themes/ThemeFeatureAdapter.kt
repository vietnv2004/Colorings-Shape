...
class ThemeFeatureAdapter(private val features: List<ThemeFeature>) : 
    RecyclerView.Adapter<ThemeFeatureAdapter.FeatureViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeatureViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_theme_feature, parent, false)
